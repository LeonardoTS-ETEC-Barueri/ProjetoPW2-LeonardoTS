...
<html lang="pt-br">
    <head>
        ...
        <title>Atividades - Programação Web 2</title>
    ...
    <body>
        <div class="container-fluid d-flex h-100 flex-column">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav align-items-center">
                        ...
                        <li class="nav-item active"> <!-- Página atual -->
                            <a class="btn btn-light py-0 m-1" href="paginaAtividades.php">Atividades</a>
                        </li>
                        <li class="nav-item">
                            <a class="btn btn-outline-light py-0 m-1" href="paginaProjetos.php">Projetos Didáticos</a>
                        </li>
                        <li class="nav-item">
            ...
            <main class="row h-100 overflow-auto flex-grow-1 bg-img" style="background-image: url('../_media/imagens/backgrounds/02-atividadesBG.jpg');"> <!-- Background do conteúdo principal -->

                <div class="col d-flex flex-wrap align-content-start justify-content-center"> <!-- Container das cards -->
                    
                    <a class="text-decoration-none" href='../_atividades/01_calculadora.php'> <!-- Início Card -->
                    <div class="card border-dark m-2" style="max-width: 18rem;"> 
                        <div class="card-header font-weight-bold darkbg-hover text-truncate">2020-08-27 - Calculadora PHP</div>
                        <div class="p-1">
                            <img src="../_media/imagens/imgCards/atv_01-Calculadora.png" class="card-img-top img-thumbnail card-image-box p-0" alt="Imagem de prévia da tarefa">
                        </div>
                        <div class="card-body text-dark border-top overflow-auto" style="max-height: 150px;">
                            <h5 class="card-title font-weight-bold lead">Calculadora PHP</h5>
                            <p class="card-text cool-p">Uma calculadora que permite: Soma; Subtração; Multiplicação; E divisão. Coletando e tratando dados enviados por um formulário HTML para o PHP.</p>
                        </div>
                    </div>
                    </a> <!-- Fim Card -->
